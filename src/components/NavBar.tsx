...
const navItems = [
  ...
  { id: 'dest', label: 'Yo‘nalishlar' },
  { id: 'why', label: 'Nega biz?' },
  { id: 'testi', label: 'Sharhlar' },
      ...
      <div className="container">
        <div className="mt-6 rounded-full glass px-5 py-3 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <a href="#cta" className="px-4 py-2 rounded-full bg-brand-500 hover:bg-brand-400 transition-colors">Bog‘lanish</a>
          </nav>

          <button onClick={() => setOpen((s) => !s)} className="md:hidden inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/10">
          ...
          >
            <div className="container">
              <div className="glass mt-2 rounded-3xl p-4 flex flex-col gap-2">
                ...
                <a href="#cta" className="py-2 px-3 rounded-xl bg-brand-500 text-center">Bog‘lanish</a>
              </div>
            </div>
          </motion.div>
        )}
